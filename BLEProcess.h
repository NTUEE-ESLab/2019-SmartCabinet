...
public:
     ...
     */
    BLEProcess(events::EventQueue &event_queue, BLE &ble_interface, char* _addr ) :
...
private:
    ...
    void when_connection(const Gap::ConnectionCallbackParams_t *connection_event)
    {
        ...
        printf("%02x:%02x:%02x:%02x:%02x:%02x\r\n",
            connection_event->peerAddr[5],
            connection_event->peerAddr[4], 
            connection_event->peerAddr[3], 
            connection_event->peerAddr[2], 
            connection_event->peerAddr[1], 
            connection_event->peerAddr[0]);
        std::sprintf( Addr,"%02x%02x%02x%02x%02x%02x",
            connection_event->peerAddr[15],
            connection_event->peerAddr[12], 
            connection_event->peerAddr[9], 
            connection_event->peerAddr[6], 
            connection_event->peerAddr[3], 
            connection_event->peerAddr[0]);
    }
